...
static
void
tun_engine_freebsd_tun_open (const char *dev, const char *dev_type, const char *dev_node, struct tuntap *tt)
{
...
static
void
tun_engine_freebsd_tun_close (struct tuntap *tt)
{
	if (tt) {
		struct argv argv;
...
static
void
tun_engine_freebsd_tun_ifconfig (
	struct tuntap *tt,
	const char *actual,
	int tun_mtu,
...
static struct tun_engine_s _tun_engine = {
	...
	tun_engine_freebsd_tun_open,
	tun_engine_freebsd_tun_close,
	NULL, /* tun_stop */
